...
const pdfTemplate = ({
    ...
    return `
      ...
      <div class="logo-title">
        <img style="height: 50px; width: 100px" src="http://res.cloudinary.com/dx9xzfhtp/image/upload/v1726828431/uploads/cjtynpt4nsj9u22zwegm.png" />
        <p style="font-size: 11px">Amigo Softcom<p/>
        </p>
      </div>
      </section>
      ...
      <div>
        ...
        <h4 style="font-size: 14px; line-height: 5px">Amigo Softcom</h4>
        <p style="font-size: 11px; line-height: 5px">assistance@amigo-software.com</p>
        <p style="font-size: 11px; line-height: 5px">+91 9252654490</p>
      </div >
      
      <div style="margin-bottom: 100px; margin-top: 1px; padding-left:5px;">
        <p class="title">Bill to:</p>
        <h4 style="font-size: 11px; line-height: 8px">NAME:  ${name}</h4>
        <p style="font-size: 11px; line-height: 8px">Email_ID: ${email}</p>
        <p style="font-size: 11px; line-height: 8px">Phone_NO: ${phoneNumber}</p>
      </div>
      
      <div class="status" style="margin-top: -200px; padding-left:5px;">
